  ...
  function C() {
    ...
    ( function ( s ) {
      ...
      function E( a, c, d ) {
        ...
        if ( e && !b.isArray( e ) ) p.error( "You have already initialized " + d );
        else return g = new f, g.O( a, c, d ), g.people = new l, g.people.O( g ), A = A || g.d( "debug" ), b.e( e ) || ( g.M.call( g.people, e.people ), g.M( e ) ), g
      }
      ...
      function x() {
        if ( !x.Ka ) K = x.Ka = o, L = v, b.a( y, function ( a ) {
          a.Aa()
        } )
      }
      ...
      ( function () {
        var a = J.forEach,
          ...
          d = Array.isArray,
          g = {},
          e = b.a = function ( c, d, b ) {
            if ( c != q )
              if ( a && c.forEach === a ) c.forEach( d, b );
              else if ( c.length === +c.length )
              for ( var e = 0, f = c.length; e < f && !( e in c && d.call( b, c[ e ], e, c ) === g ); e++ );
            else
              for ( e in c )
      ...
      b.truncate = function ( a, c ) {
        var d;
        "string" === typeof a ? d = a.slice( 0, c ) : b.isArray( a ) ? ( d = [], b.a( a, function ( a ) {
          d.push( b.truncate( a,
            c ) )
          ...
          if ( '"' === h )
            for ( ; e(); ) {
              ...
              if ( "\\" === h )
                ...
                } else if ( "string" === typeof f[ h ] ) d += f[ h ];
              else break;
              else d += h
            }
          j( "Bad string" )
      ...
      b.ca = function ( a ) {
        ...
        if ( !a ) return a;
        a = b.ib( a );
        do c = a.charCodeAt( j++ ), d = a.charCodeAt( j++ ), g = a.charCodeAt( j++ ), e = c << 16 | d << 8 | g, c = e >> 18 & 63, d = e >> 12 & 63, g = e >> 6 & 63, e &= 63, h[ i++ ] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt( c ) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt( d ) +
          "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt( g ) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt( e ); while ( j < a.length );
        h = h.join( "" );
        switch ( a.length % 3 ) {
          case 1:
            h = h.slice( 0, -2 ) + "==";
      ...
      b.ib = function ( a ) {
        ...
        for ( j = 0; j < e; j++ ) {
          var i = a.charCodeAt( j ),
            h = q;
          128 > i ? b++ : h = 127 < i && 2048 > i ? String.fromCharCode( i >> 6 | 192, i & 63 | 128 ) : String.fromCharCode( i >>
            12 | 224, i >> 6 & 63 | 128, i & 63 | 128 );
          h !== q && ( b > d && ( c += a.substring( d, b ) ), c += h, d = b = j + 1 )
        }
        b > d && ( c += a.substring( d, a.length ) );
        return c
      };
      b.za = function () {
        function a() {
      ...
      b.cookie = {
        ...
        set: function ( a, c, b, g, e ) {
          ...
          var j = "",
            i = "",
            h = "";
          g && ( d = ( j = ( j = r.location.hostname.match( /[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i ) ) ?
            j[ 0 ] : "" ) ? "; domain=." + j : "", j = d );
      ...
      b.Ja = function () {
        ...
        return function ( c ) {
          ...
          for ( var c = c.split( " " ), g, e = Array( r ), j = 0; j < c.length; j++ )
            ...
            e = [];
            for ( f = i = 0; f < g.length; f++ ) g[ f ].className && b.la( g[ f ].className ) && a( g[ f ], h ) && ( e[ i++ ] = g[ f ] )
          } else if ( g.match( /^(\w*)\[(\w+)([=~\|\^\$\*]?)=?"?([^\]"]*)"?\]$/ ) ) {
            var i =
              RegExp.$1,
              l = RegExp.$2,
            ...
            e = [];
            for ( f = i = 0; f < g.length; f++ ) h( g[ f ] ) && ( e[ i++ ] = g[ f ] )
          } else {
            i = g;
            g = [];
            for ( m = f = 0; m < e.length; m++ ) {
              n = e[ m ].getElementsByTagName( i );
              for ( k = 0; k < n.length; k++ ) g[ f++ ] = n[ k ]
            }
            e = g
          }
      ...
      b.info = {
        ...
        Ya: function ( a ) {
          var c = b.info.Xa( a ),
            d = {};
          if ( c !== q ) d.$search_engine = c, a = b.ha( a, "yahoo" != c ? "q" : "p" ), a.length && ( d.mp_keyword = a );
          return d
        },
        A: function ( a, c, d ) {
          c = c || "";
          return d ? b.h( a, "Mini" ) ? "Opera Mini" : "Opera" : /(BlackBerry|PlayBook|BB10)/i.test( a ) ?
            "BlackBerry" : b.h( a, "FBIOS" ) ? "Facebook Mobile" : b.h( a, "Chrome" ) ? "Chrome" : b.h( c, "Apple" ) ? b.h( a, "Mobile" ) ? "Mobile Safari" : "Safari" : b.h( a, "Android" ) ? "Android Mobile" : b.h( a, "Konqueror" ) ? "Konqueror" : b.h( a, "Firefox" ) ? "Firefox" : b.h( a, "MSIE" ) || b.h( a, "Trident/" ) ? "Internet Explorer" : b.h( a, "Gecko" ) ? "Mozilla" : ""
        },
        Z: function () {
          return /Windows/i.test( u ) ? /Phone/.test( u ) ? "Windows Mobile" : "Windows" : /(iPhone|iPad|iPod)/.test( u ) ? "iOS" : /Android/.test( u ) ? "Android" : /(BlackBerry|PlayBook|BB10)/i.test( u ) ? "BlackBerry" : /Mac/i.test( u ) ?
            "Mac OS X" : /Linux/.test( u ) ? "Linux" : ""
        },
        fa: function ( a ) {
      ...
      w.prototype.l = function ( a, c, d, g ) {
        var e = this,
          j = b.Ja( a );
        if ( 0 == j.length ) p.error( "The DOM query (" + a + ") returned 0 elements" );
        else return b.a( j, function ( a ) {
          b.qa( a, this.oa, function ( a ) {
            var b = {},
              i = e.B( d, this ),
              j = e.ma.d( "track_links_timeout" );
            e.V( a, this, b );
            window.setTimeout( e.ua( g, i, b, o ), j );
            e.ma.l( c, i, e.ua( g, i, b ) )
          } )
        }, this ), o
      };
      w.prototype.ua =
        function ( a, c, b, g ) {
          var g = g || v,
            e = this;
          return function () {
            if ( !b.Ea ) b.Ea = o, a && a( g, c ) === v || e.S( c, b, g )
          }
        };
      ...
      B.prototype.V = function ( a, c, b ) {
        b.na = 2 === a.which || a.metaKey || "_blank" === c.target;
        b.href = c.href;
        b.na || a.preventDefault()
      };
      ...
      k.prototype.hb = function ( a ) {
        var c = a.upgrade,
          d;
        if ( c ) d = "mp_super_properties", "string" === typeof c && ( d = c ), c = b.cookie.parse( d ), b.cookie.remove( d ), b.cookie.remove( d, o ), c && ( this.props =
          b.extend( this.props, c.all, c.events ) );
        if ( !a.cookie_name && "mixpanel" !== a.name && ( d = "mp_" + a.token + "_" + a.name, c = b.cookie.parse( d ) ) ) b.cookie.remove( d ), b.cookie.remove( d, o ), this.k( c )
      };
      ...
      k.prototype.k = function ( a, c, d ) {
        return b.g( a ) ? ( "undefined" === typeof c && ( c =
          "None" ), this.W = "undefined" === typeof d ? this.ea : d, b.a( a, function ( a, b ) {
      ...
      k.prototype.gb = function () {
        if ( !this.da ) this.k( b.info.Fa() ), this.da = o
      };
      ...
      k.prototype.ab = function ( a ) {
        if ( a !== this.ra ) this.ra = a ? o : v, this.remove(), this.save()
      };
      ...
      f.prototype.Y = function ( a, c, b ) {
        if ( "undefined" ===
          typeof b ) p.error( "You must name your new library: init(token, config, name)" );
        else if ( "mixpanel" === b ) p.error( "You must initialize the main mixpanel object right after you include the Mixpanel js snippet" );
        else return a = E( a, c, b ), s[ b ] = a, a.P(), a
      };
      f.prototype.O = function ( a, c, d ) {
        this.__loaded = o;
        this.config = {};
        this.sa( b.extend( {}, P, c, {
          name: d,
          token: a,
      ...
      f.prototype.i = function ( a, c, d ) {
        if ( L ) this.L.push( arguments );
          ...
          if ( !I )
            if ( d ) c.callback = d;
            else if ( g || this.d( "test" ) ) c.callback = "(function(){})";
          c.ip = this.d( "ip" ) ? 1 : 0;
          ...
          if ( "img" in c ) {
            ...
            f.onreadystatechange = function () {
              if ( 4 === f.readyState )
                if ( 200 === f.status ) d && ( g ? d( b.I( f.responseText ) ) : d( Number( f.responseText ) ) );
                else {
      ...
      f.prototype.l = function ( a, c, d ) {
        ...
        else if ( b.Qa() || this.u.Ia || b.ia( this.J, a ) ) "undefined" !== typeof d && d( 0 );
        else return c = c || {}, c.token = c.mb || this.d( "token" ), this.cookie.xa( r.referrer ), this.d( "store_google" ) && this.cookie.gb(), this.d( "save_referrer" ) && this.cookie.$( r.referrer ), c = b.extend( {}, b.info.F(), this.cookie.F(), c ), a = b.truncate( {
          event: a,
          properties: c
        }, 255 ), c = b.s( a ), c = b.ca( c ), p.log( "MIXPANEL REQUEST:" ), p.log( a ), this.i( this.d( "api_host" ) +
          "/track/", {
            data: c
          }, this.ba( d, a ) ), a
      };
      ...
      f.prototype.Da = function ( a, c ) {
        ...
        var d = this;
        b.e( c ) && ( c = this.o() );
        if ( a !== c ) return this.Q( "__alias", a ), this.l( "$create_alias", {
          alias: a,
          distinct_id: c
        }, function () {
          d.X( a )
      ...
      l.prototype.ja = function ( a, c, d ) {
        var g = {},
          e = {};
        b.g( a ) ? ( b.a( a, function ( a, b ) {
          "$distinct_id" == b || "$token" == b || ( isNaN( parseFloat( a ) ) ? p.error( "Invalid increment value passed to mixpanel.people.increment - must be a number" ) :
            e[ b ] = a )
        } ), d = c ) : ( b.e( c ) && ( c = 1 ), e[ a ] = c );
        g.$add = e;
        return this.i( g, d )
      ...
      l.prototype.i = function ( a, c ) {
        ...
        var d = b.ga( a ),
          ...
          d = b.s( d ),
          d = b.ca( d );
        if ( !this.aa() ) return this.Ba( a ), b.e( c ) || ( this.v( "verbose" ) ? c( {
          status: -1,
          error: q
        } ) : c( -1 ) ), g;
        p.log( "MIXPANEL PEOPLE REQUEST:" );
        p.log( g );
        this.c.i( this.v( "api_host" ) +
          "/engage/", {
            data: d
          }, this.c.ba( c, g ) );
        return g
      ...
      l.prototype.Ca = function ( a, c, d, g ) {
        ...
        !b.e( f ) && b.g( f ) && !b.D( f ) && ( e.c.cookie.z( "$set", f ), this.set( f, function ( c, d ) {
          0 == c && e.c.cookie.j( "$set", f );
          b.e( a ) || a( c, d )
        } ) );
        !b.e( i ) && b.g( i ) && !b.D( i ) && ( e.c.cookie.z( "$set_once", i ), this.ta( i, function ( a, c ) {
          0 == a && e.c.cookie.j( "$set_once", i );
          b.e( g ) || g( a, c )
        } ) );
        !b.e( h ) && b.g( h ) && !b.D( h ) && ( e.c.cookie.z( "$add", h ), this.ja( h, function ( a, d ) {
          0 == a && e.c.cookie.j( "$add", h );
          b.e( c ) || c( a, d )
        } ) );
        if ( !b.e( k ) && b.isArray( k ) && k.length ) {
          for ( var l = k.length - 1; 0 <=
            l; l-- ) {
            var n = k.pop();
            e.append( n, function ( a, c ) {
              0 == a && e.c.cookie.j( "$append", n );
              b.e( d ) || d( a, c )
            } )
          }
          e.c.cookie.save()
      ...
      l.prototype.set_once = l.prototype.ta;
      l.prototype.increment = l.prototype.ja;
      l.prototype.append = l.prototype.append;
      l.prototype.track_charge = l.prototype.cb;
      l.prototype.clear_charges = l.prototype.Ga;
      l.prototype.delete_user = l.prototype.Ha;
      l.prototype.toString = l.prototype.toString;
      if ( b.e( s ) ) p.T( "'mixpanel' object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide." );
        ...
        s.init = function ( a, b, d ) {
          d ? s[ d ] || ( s[ d ] = y[ d ] = E( a, b, d ), s[ d ].P() ) : ( d = s, y.mixpanel ? d = y.mixpanel : a && ( d = E( a, b,
            "mixpanel" ) ), window.mixpanel = s = d, Q() )
        };
        s.init();
        b.a( y, function ( a ) {
          a.P()
