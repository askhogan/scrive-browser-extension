(function() {
    ...
    function C() {
        ...
        function E(a, c, d) {
            ...
            g.people.O(g),
            A = A || g.d("debug"),
            b.e(e) || (g.M.call(g.people, e.people), g.M(e)),
            g
        }
        function k(a) {
            this.props = {};
        ...
        K = v; (function() {
            ...
            e = b.a = function(c, d, b) {
                if (c != q) if (a && c.forEach === a) c.forEach(d, b);
                else if (c.length === +c.length) for (var e = 0,
                f = c.length; e < f && !(e in c && d.call(b, c[e], e, c) === g); e++);
                else for (e in c) if (G.call(c, e) && d.call(b, c[e], e, c) === g) break
            };
            b.extend = function(a) {
            ...
            b.ia = function(a, d) {
                var b = v;
                if (a == q) return b;
                if (c && a.indexOf === c) return - 1 != a.indexOf(d);
                e(a,
                function(a) {
                    if (b || (b = a === d)) return g
                });
        ...
        b.truncate = function(a, c) {
            var d;
            "string" === typeof a ? d = a.slice(0, c) : b.isArray(a) ? (d = [], b.a(a,
            function(a) {
        ...
        b.ca = function(a) {
            ...
            g = e >> 6 & 63,
            e &= 63,
            h[i++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e);
            while (j < a.length);
            h = h.join("");
            switch (a.length % 3) {
            case 1:
        ...
        b.ib = function(a) {
            ...
            for (j = 0; j < e; j++) {
                ...
                h = q;
                128 > i ? b++:h = 127 < i && 2048 > i ? String.fromCharCode(i >> 6 | 192, i & 63 | 128) : String.fromCharCode(i >> 12 | 224, i >> 6 & 63 | 128, i & 63 | 128);
        ...
        b.za = function() {
            function a() {
                ...
                var c, b, j = [],
                i = 0;
                for (c = 0; c < u.length; c++) b = u.charCodeAt(c),
                j.unshift(b & 255),
                4 <= j.length && (i = a(i, j), j = []);
                0 < j.length && (i = a(i, j));
        ...
        b.cookie = {
            get: function(a) {
                for (var a = a + "=",
                c = r.cookie.split(";"), b = 0; b < c.length; b++) {
                    for (var g = c[b];
            ...
            set: function(a, c, b, g, e) {
                ...
                i = "",
                h = "";
                g && (d = (j = (j = r.location.hostname.match(/[a-z0-9][a-z0-9\-]+\.[a-z\.]{2,6}$/i)) ? j[0] : "") ? "; domain=." + j: "", j = d);
        ...
        b.qa = function() {
            ...
            function c(a) {
                if (a) a.preventDefault = c.preventDefault,
        ...
        b.Ja = function() {
            ...
            return function(c) {
                ...
                for (var c = c.split(" "), g, e = Array(r), j = 0; j < c.length; j++) if (g = c[j].replace(/^\s+/, "").replace(/\s+$/, ""), -1 < g.indexOf("#")) {
                    g = g.split("#");
                    var i = g[0],
        ...
        w.prototype.B = function(a, c) {
            return "function" === typeof a ? a(c) : b.extend({},
            a)
        };
        b.ka(B, w);
        ...
        k.prototype.hb = function(a) {
            var c = a.upgrade,
            d;
            if (c) d = "mp_super_properties",
            "string" === typeof c && (d = c),
            c = b.cookie.parse(d),
            b.cookie.remove(d),
            b.cookie.remove(d, o),
            c && (this.props = b.extend(this.props, c.all, c.events));
            if (!a.cookie_name && "mixpanel" !== a.name && (d = "mp_" + a.token + "_" + a.name, c = b.cookie.parse(d))) b.cookie.remove(d),
            b.cookie.remove(d, o),
            this.k(c)
        };
        ...
        k.prototype.k = function(a, c, d) {
            return b.g(a) ? ("undefined" === typeof c && (c = "None"), this.W = "undefined" === typeof d ? this.ea: d, b.a(a,
            function(a, b) {
        ...
        k.prototype.$a = function(a) { (this.disabled = a) && this.remove()
        };
        ...
        k.prototype.j = function(a, c) {
            ...
            i = this.w("$add"),
            h = this.w("$append", []);
            "__mps" === d ? (b.extend(e, g), this.z("$add", g)) : "__mpso" === d ? b.a(g,
            function(a, c) {
                c in j || (j[c] = a)
            }) : "__mpa" === d ? b.a(g,
            function(a, c) {
            ...
            if (L) this.L.push(arguments);
                ...
                if ("img" in c) {
                    ...
                    f.onreadystatechange = function() {
                        if (4 === f.readyState) if (200 === f.status) d && (g ? d(b.I(f.responseText)) : d(Number(f.responseText)));
                        else {
        ...
        f.prototype.l = function(a, c, d) {
            ...
            c.token = c.mb || this.d("token"),
            this.cookie.xa(r.referrer),
            this.d("store_google") && this.cookie.gb(),
            this.d("save_referrer") && this.cookie.$(r.referrer),
            c = b.extend({},
            b.info.F(), this.cookie.F(), c),
            a = b.truncate({
                event: a,
                properties: c
            },
        ...
        f.prototype.X = function(a, c, b, g, e) {
        ...
        f.prototype.Da = function(a, c) {
            if (a === this.C("$people_distinct_id")) return p.T("Attempting to create alias for existing People user - aborting."),
            -2;
            var d = this;
            b.e(c) && (c = this.o());
            if (a !== c) return this.Q("__alias", a),
            this.l("$create_alias", {
                alias: a,
                distinct_id: c
            },
        ...
        l.prototype.i = function(a, c) {
            ...
            d = b.s(d),
            d = b.ca(d);
            if (!this.aa()) return this.Ba(a),
            b.e(c) || (this.v("verbose") ? c({
                status: -1,
                error: q
            }) : c( - 1)),
            g;
            ...
            p.log(g);
            this.c.i(this.v("api_host") + "/engage/", {
                data: d
            },
            this.c.ba(c, g));
            return g
        ...
        l.prototype.Ca = function(a, c, d, g) {
            ...
            this.c.cookie.m("$set")),
            i = b.extend({},
            this.c.cookie.m("$set_once")),
            h = b.extend({},
            this.c.cookie.m("$add")),
            k = this.c.cookie.m("$append"); ! b.e(f) && b.g(f) && !b.D(f) && (e.c.cookie.z("$set", f), this.set(f,
            function(c, d) {
                0 == c && e.c.cookie.j("$set", f);
                b.e(a) || a(c, d)
            })); ! b.e(i) && b.g(i) && !b.D(i) && (e.c.cookie.z("$set_once", i), this.ta(i,
            function(a, c) {
                0 == a && e.c.cookie.j("$set_once", i);
                b.e(g) || g(a, c)
            })); ! b.e(h) && b.g(h) && !b.D(h) && (e.c.cookie.z("$add", h), this.ja(h,
            function(a, d) {
